      ...
      <main>
        ...
        <div className="py-24 bg-shark-50 sm:py-32">
          <div className="max-w-md mx-auto pl-4 pr-8 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <p className="mt-6 max-w-3xl mx-auto text-xl leading-normal text-shark-500 text-center">
        ...
        {/* Contact Section */}
        <div className="relative bg-shark-50">
          ...
          <div className="relative py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:py-32 lg:grid lg:grid-cols-2">
            <div className="lg:pr-8">
              <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                ...
                <p className="mt-4 text-lg text-shark-500 sm:mt-3">
                ...
                >
                  <div>
                    <label
                      htmlFor="first-name"
                      className="block text-sm font-medium text-shark-700"
                    >
                      First name
                    </label>
                    <div className="mt-1">
                  ...
                  <div className="sm:col-span-2">
                    <div className="flex justify-between">
                      ...
                      <span id="phone-description" className="text-sm text-shark-500">
                        Optional
                      </span>
                    </div>
                    <div className="mt-1">
                  ...
                  <div className="sm:col-span-2">
                    <div className="flex justify-between">
                      ...
                      <span
                        ...
                        className="text-sm text-shark-500"
                      >
                        Max. 500 characters
                      </span>
                    </div>
                  ...
                  <fieldset className="sm:col-span-2">
                    <legend className="block text-sm font-medium text-shark-700">
                      Expected budget
                    </legend>
        ...
        <div className="bg-aqua-400">
          <div className="max-w-md mx-auto text-center py-16 px-4 sm:max-w-2xl sm:py-24 sm:px-6 lg:px-8 lg:py-32">
            ...
            >
              ...
              <ExternalLinkIcon
                className="ml-3 h-5 w-5 flex-shrink-0 text-shark-400"
                aria-hidden="true"
              />
            </a>
          </div>
