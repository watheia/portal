        ...
        <main>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    <a
                      href="#"
                      className="inline-flex items-center text-shark-50 bg-shark-900 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200"
                    >
                      ...
                      <span className="ml-4 text-sm text-secondary-2">
                    ...
                    <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-shark-50 sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      ...
                      <span className="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-aqua-200 to-regal-400 sm:pb-5">
                        ship web apps
                      </span>
                    </h1>
                      ...
                      <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                        <div className="sm:flex">
                          <div className="min-w-0 flex-1">
                            ...
                            <input
                              ...
                              className="block w-full px-4 py-3 rounded-md border-0 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-regal-400 focus:ring-offset-gray-900"
                            />
                          </div>
                          <div className="mt-3 sm:mt-0 sm:ml-3">
                            <button
                              type="submit"
                              className="block w-full py-3 px-4 rounded-md shadow bg-gradient-to-r from-aqua-500 to-regal-400 text-shark-50 font-medium hover:from-aqua-600 hover:to-regal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-regal-400 focus:ring-offset-gray-900"
                            >
                              Request login
                            </button>
                          </div>
                        ...
                        <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                          ...
                          <a
                            ...
                            className="font-medium text-shark-50"
                          >
          ...
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
            <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
              <div>
                <h2 className="text-base font-semibold tracking-wider text-regal-600 uppercase">
                  Serverless
                </h2>
                        ...
                        <div className="-mt-6">
                          <div>
                            <span className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-aqua-500 to-regal-400 rounded-md shadow-lg">
                              <feature.icon
                                className="h-6 w-6 text-shark-50"
                                aria-hidden="true"
                              />
                            </span>
                          </div>
          ...
          {/* Testimonial section */}
          <div className="pb-16 bg-gradient-to-r from-aqua-500 to-regal-600 lg:pb-0 lg:z-10 lg:relative">
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
                  <blockquote>
                    <div>
                      ...
                      <p className="mt-6 text-2xl font-medium text-shark-50">
                    ...
                    <footer className="mt-6">
                      <p className="text-base font-medium text-shark-50">Judith Black</p>
                      <p className="text-base font-medium text-regal-100">
                        CEO at PureInsights
                      </p>
                    </footer>
                  </blockquote>
              ...
              <div className="md:ml-auto md:w-1/2 md:pl-10">
                ...
                <div className="mt-8">
                  <div className="inline-flex rounded-md shadow">
                    <a
                      href="#"
                      className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-shark-50 hover:bg-gray-50"
                    >
